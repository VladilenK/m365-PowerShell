...
Get-PnPPropertyBag -Key "SiteCustomSubject"  -Connection $connectionSite # RefinableString09
...
Set-PnPPropertyBagValue -Key "SiteCustomSubject" -Value "Test Test1" -Indexed:$true -Connection $connectionSite
Set-PnPPropertyBagValue -Key "SiteCustomSubject" -Value "Test Test2" -Indexed:$true -Connection $connectionSite
