$siteUrl = "https://uhgdev.sharepoint.com/sites/TestTeamSite_01"
Connect-PnPOnline -Url $siteUrl -ClientId $clientID -Certificate $cert -Tenant $tenant -CertificatePassword $certPw -Verbose
Get-PnPSite | ft -a
