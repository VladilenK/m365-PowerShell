...
$sourcePath = "M:\V"   # original "do no touch" files
...
$deduplPath = "T:\" # files to clean-up - remove duplications
$deduplPath = "M:\_Photos.All" # files to clean-up - remove duplications - M 603GB free
